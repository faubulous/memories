...
export class TimelineLayout2 extends VirtualCanvasLayouterBase {
    private padding:
        {
            top: number,
            left: number | 'auto',
    ...
    constructor(zone: NgZone, stage: Stage, dataSource: VirtualCanvasDataSource) {
        super(zone, stage, dataSource);
